...
```{r}
ggplot(data.frame(x = seq(-10, 10, lenght = 100)), aes(x = x))+
...
```
We are 99% confident that population mean female shark total length is in between 115.12 inch
and 118.6 inch
